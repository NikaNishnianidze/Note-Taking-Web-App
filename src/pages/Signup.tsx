...
export default function Signup() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      <div className="container w-[343px] tb:w-[522px] dk:w-[540px] tb:flex tb:flex-col tb:items-center py-[48px] px-[16px] dark:bg-[#0E121B] bg-white rounded-[12px]">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="email mt-[40px] flex flex-col tb:items-center gap-[6px]">
            ...
            <input
              ...
              className="w-[311px] tb:w-[458px] dk:w-[444px] py-[12px] px-[16px] shadow-input rounded-[8px] border-[1px] border-[#CACFD8] dark:bg-[#0E121B] dark:border-[#525866] outline-none text-[14px] font-normal text-[#717784]"
            />
          ...
          <div className="password relative mt-[16px] flex flex-col items-center gap-[6px] ">
            <label
              htmlFor="password"
              className="text-[14px] w-[311px] tb:w-[458px] dk:w-[444px] dark:text-white text-[#0E121B] font-semibold"
            >
              Password
            </label>
            <input
              ...
              id="password"
              {...register("password")}
              className="w-[311px] tb:w-[458px] dk:w-[444px] py-[12px] px-[16px] shadow-input rounded-[8px] dark:border-[#525866] border-[1px] border-[#CACFD8] outline-none text-[14px] font-normal text-[#717784]"
            />
            <img
              src={isPasswordVisible ? hidePasswordIcon : showPasswordIcon}
              alt="show/hide password icon"
              style={{ cursor: "pointer" }}
              className="w-[20px] h-[20px] absolute right-[15px] dk:right-[20px] tb:right-[25px] top-[65%] transform -translate-y-[50%]"
          ...
          <div className="submit-button tb:flex tb:justify-center">
            <button
              type="submit"
              className="mt-[16px] tb:w-[458px] dk:w-[444px] w-[311px] py-[12.5px] rounded-[8px] bg-[#335CFF] text-white text-[14px] font-semibold "
            >
              Sign up
            </button>
          </div>
        ...
        <button className="mt-[16px] tb:w-[458px] dk:w-[444px] w-[311px] flex items-center gap-[16px] justify-center text-[16px] text-[#0E121B] font-semibold border-[1px] border-[#CACFD8] rounded-[12px] py-[16px]">
          <img
            src={googleIcon}
            alt=""
            className="dark:filter dark:brightness-0 dark:invert"
